...
def read_toast_h_maps(
    ...
    * sin_1: the spin dependence and component written, here the $h_n$ component with spin 1 
    ...
    if reweight_by_hits:
        h_n_spinmaps = reweight_hmaps_by_hits(
            h_dictionary=h_n_spinmaps,
